...
// New background snippets
const BgLightGradient7 = () => {
  return (
    <div className="absolute inset-0 -z-10 h-full w-full bg-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_500px_at_50%_50%,#f7d0ff,transparent_120%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_400px_at_70%_20%,#d5f5ff,transparent_100%)]" />
    </div>
  );
};

const BgDarkGradient6 = () => {
  return (
    <div className="relative h-full w-full bg-slate-950">
      <div className="absolute inset-0 bg-[radial-gradient(circle_400px_at_50%_-50%,#3b0764,transparent)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_400px_at_30%_50%,#0c4a6e,transparent)]" />
    </div>
  );
};

const BgLightGridGradient3 = () => {
  return (
    <div className="absolute inset-0 -z-10 h-full w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:4rem_4rem]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_400px_at_50%_-100%,#e9d5ff,transparent)] blur-lg" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_400px_at_80%_50%,#bfdbfe,transparent)]" />
    </div>
  );
};

const BgDarkGridGradient2 = () => {
  return (
    <div className="relative h-full w-full bg-black">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_400px_at_50%_-100%,#3b0764,transparent)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_400px_at_80%_50%,#1e1b4b,transparent)]" />
    </div>
  );
};
...
export const BACKGROUND_OPTIONS = [
  ...
  {
    name: 'Background Light Gradient 7',
    component: <BgLightGradient7 />,
    theme: 'light',
  },
  {
  ...
  {
    name: 'Background Light Grid Gradient 3',
    component: <BgLightGridGradient3 />,
    theme: 'light',
  },
  {
  ...
  {
    name: 'Background Dark Gradient 6',
    component: <BgDarkGradient6 />,
    theme: 'dark',
  },
  {
  ...
  {
    name: 'Background Dark Grid Gradient 2',
    component: <BgDarkGridGradient2 />,
    theme: 'dark',
  },
  {
